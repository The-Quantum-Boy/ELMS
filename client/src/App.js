...
import { LeaveMgnt,AllLeaves,PendingLeaves,ApprovedLeaves,NotApprovedLeaves } from './pages/LeaveMgnt';
    ...
    <div className="App">
      ...
      <Router>
        <Routes>
          ...
          <Route exact path="/EmpServices/AddEmployee" element={<AddEmployee/>}/>
          <Route exact path="/EmpServices/ManageEmp" element={<ManageEmp/>}/>
          <Route exact path="/LeaveMgnt" element={<LeaveMgnt/>}/>
          <Route exact path="/LeaveMgnt/AllLeaves" element={<AllLeaves/>}/>
          <Route exact path="/LeaveMgnt/PendingLeaves" element={<PendingLeaves/>}/>
          <Route exact path="/LeaveMgnt/ApprovedLeaves" element={<ApprovedLeaves/>}/>
          <Route exact path="/LeaveMgnt/NotApprovedLeaves" element={<NotApprovedLeaves/>}/>
          <Route exact path="/Leaves" element={<Leaves/>}/>
          <Route exact path="/Leaves/LeaveApply" element={<LeaveApply/>}/>
          <Route exact path="/Leaves/LeaveHistory" element={<LeaveHistory/>}/>
