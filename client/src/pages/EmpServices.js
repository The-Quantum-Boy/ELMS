...
export const EmpServices = () => {
  ...
  const addLeave = async (empId, leaveNum) => {
    console.log("i am in add leave fun");
    try {
      const res = await fetch("/addLeaveNum", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
        body: JSON.stringify({ empId, leaveNum }),
      });
      ...
      if (res.status === 200) {
        setModalShow(false);
        toast.success("Leave limit is added!", {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
          closeOnClick: true,
    ...
    <>
                        ...
                        <td>
                          {(() => {
                            if (emp.empStatus === 0) {
                              return (
                                <>
                                  <b style={{ color: "#ff1a1a" }}>Inactive</b>
                                </>
                              );
                            } else {
                              return (
                                <>
                                  <b style={{ color: "#3CB371" }}>Active</b>
                                </>
                              );
                            }
                          })()}
                              ...
                              return (
                                <>
                                  <BiX
                                    type="submit"
                                    onClick={() =>
                                      postStaus(emp.empId, emp.empStatus)
                                    }
                                  />
                                </>
                              );
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button onClick={() => addLeave(globalEmp, leaveNum)}>Add</Button>
        </Modal.Footer>
      </Modal>
    </>
  );
...
export const AddEmployee = () => {
  ...
  return (
    <>
      ...
      <center>
        <div
          className=" border  p-4 d-inline-block mx-auto shadow-sm rounded-lg"
          style={{ marginTop: "60px", width: "68%", height: "90%" }}
        >
